...
INSERT INTO BOOK(CATEGORY, BORROW, ISBN, PAGES, RELEASE_DATE, SUMMARY, TITLE, AUTHOR_ID) VALUES ('HISTORY', FALSE,'2864576896573', 245, '1994-01-01', 'The article is an attempt at accounting for the apparent differences in meaning between the Polish word umysÅ‚ and its English dictionary equivalent.', 'Zniewolony Umysl', 1);
...
INSERT INTO BOOK(CATEGORY, BORROW, ISBN, PAGES, RELEASE_DATE, SUMMARY, TITLE, AUTHOR_ID) VALUES ('HORROR', FALSE,'4464576896599', 477, '1990-01-01', 'The article deals with the novel The Issa Valley, written by the Nobel laureate in literature CzesÅ‚aw MiÅ‚osz, and its eponymous film adaptation by film director Tadeusz Konwicki. Both authors were born in the region of todayâ€™s Lithuania, which, with its intact natural environment and ancient folk beliefs, left a strong mark on their childhoods.', 'Dolina Issy', 2);
